...
const Home = () => {
  ...
  return (
    <div className="font-sans">
      ...
      {/* Hero Section */}
      <div className="bg-sky-50 pt-32 pb-16 md:pt-40 md:pb-24 px-6">
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-8">
            ...
            <div className="bg-white rounded-xl shadow-md overflow-hidden hover:shadow-lg transition-shadow duration-300">
              <div className="relative">
                <img 
                  src="https://images.unsplash.com/photo-1602288637782-6e1d008de1a4?q=80&w=800" 
                  alt="Modern Wooden Bed" 
              ...
              <div className="p-6">
                <div className="flex justify-between items-start">
                  <h3 className="text-lg font-semibold text-gray-800">Modern Wooden Bed</h3>
                  <span className="bg-sky-100 text-sky-600 text-xs px-2 py-1 rounded">New</span>
                </div>
                <div className="mt-2 flex items-center">
                  ...
                  <span className="text-gray-500 text-xs ml-1">(124 reviews)</span>
                </div>
                <div className="mt-3">
                  <p className="text-xl font-bold text-sky-600">
                    ₹45,999 <span className="text-gray-400 line-through text-sm ml-1">₹52,999</span>
                  </p>
                  <p className="text-gray-600 mt-2 text-sm">
                    Elegant solid wood platform bed with built-in storage and minimalist design.
                  </p>
                </div>
                <button className="mt-4 w-full bg-white border border-sky-400 text-sky-500 py-2 rounded-lg hover:bg-sky-50 transition flex justify-center items-center gap-2">
            ...
            <div className="bg-white rounded-xl shadow-md overflow-hidden hover:shadow-lg transition-shadow duration-300">
              <div className="relative">
                <img 
                  src="https://images.unsplash.com/photo-1582582494700-040e6f9f71a5?q=80&w=800" 
              ...
              <div className="p-6">
                <div className="flex justify-between items-start">
                  <h3 className="text-lg font-semibold text-gray-800">Elegant Dining Set</h3>
                  <span className="bg-red-100 text-red-600 text-xs px-2 py-1 rounded">-10%</span>
                </div>
                <div className="mt-2 flex items-center">
                  <div className="flex text-yellow-400">
                    {[...Array(5)].map((_, i) => (
                ...
                <div className="mt-3">
                  <p className="text-xl font-bold text-sky-600">
                    ₹89,999 <span className="text-gray-400 line-through text-sm ml-1">₹99,999</span>
                  </p>
                  <p className="text-gray-600 mt-2 text-sm">
                    Complete 6-seater dining set with solid wood table and upholstered chairs.
                  </p>
                </div>
                <button className="mt-4 w-full bg-white border border-sky-400 text-sky-500 py-2 rounded-lg hover:bg-sky-50 transition flex justify-center items-center gap-2">
                  <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            ...
            <div className="bg-white rounded-xl shadow-md overflow-hidden hover:shadow-lg transition-shadow duration-300">
              <div className="relative">
                <img 
                  src="https://images.unsplash.com/photo-1601987077675-265cc5d0b7d1?q=80&w=800" 
              ...
              <div className="p-6">
                <div className="flex justify-between items-start">
                  <h3 className="text-lg font-semibold text-gray-800">Home Décor Collection</h3>
                  <span className="bg-green-100 text-green-600 text-xs px-2 py-1 rounded">Bestseller</span>
                </div>
                <div className="mt-2 flex items-center">
                  <div className="flex text-yellow-400">
                    {[...Array(4)].map((_, i) => (
                  ...
                  <span className="text-gray-500 text-xs ml-1">(67 reviews)</span>
                </div>
                <div className="mt-3">
                  <p className="text-xl font-bold text-sky-600">
                    ₹12,999 <span className="text-gray-400 line-through text-sm ml-1">₹15,999</span>
                  </p>
                  <p className="text-gray-600 mt-2 text-sm">
                    Curated collection of premium home décor accessories and lighting.
                  </p>
                </div>
                <button className="mt-4 w-full bg-white border border-sky-400 text-sky-500 py-2 rounded-lg hover:bg-sky-50 transition flex justify-center items-center gap-2">
                  <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            ...
            <div className="bg-white rounded-xl shadow-md overflow-hidden hover:shadow-lg transition-shadow duration-300">
              ...
              <div className="p-6">
                <div className="flex justify-between items-start">
                  <h3 className="text-lg font-semibold text-gray-800">Luxury Armchair</h3>
                  <span className="bg-purple-100 text-purple-600 text-xs px-2 py-1 rounded">Limited</span>
                </div>
                <div className="mt-2 flex items-center">
                  <div className="flex text-yellow-400">
                    {[...Array(5)].map((_, i) => (
                ...
                <div className="mt-3">
                  <p className="text-xl font-bold text-sky-600">
                    ₹24,999 <span className="text-gray-400 line-through text-sm ml-1">₹29,999</span>
                  </p>
                  <p className="text-gray-600 mt-2 text-sm">
                    Premium leather armchair with ergonomic design and adjustable features.
                  </p>
                </div>
                <button className="mt-4 w-full bg-white border border-sky-400 text-sky-500 py-2 rounded-lg hover:bg-sky-50 transition flex justify-center items-center gap-2">
                  <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
          ...
          <div className="text-center mt-12">
            <button className="px-8 py-3 bg-sky-600 hover:bg-sky-700 text-white font-medium rounded-lg shadow transition">
              View All Products
            </button>
          </div>
        </div>
