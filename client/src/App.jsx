...
const AdminHome = lazy(() => import('./adminPanel/AdminHome'));
...
const ProductCreate = lazy(() => import('./adminPanel/Product/ProductCreate')); 
const App = () => {
  return (
    <Router>
      <Reset />
      ...
      <Suspense fallback={<Loader />}>
        <Routes>
          ...
          <Route path='/productCreation' element={<ProductCreate/>} />
